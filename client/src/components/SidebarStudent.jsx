...
const SidebarStudent = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const navLinks = [
    { path: "/student/dashboard", icon: "🏠", label: "الرئيسية" },
    { path: "/student/classes", icon: "📚", label: "الصفوف" },
    { path: "/student/messages", icon: "✉️", label: "الرسائل" },
    { path: "/student/profile", icon: "👤", label: "الملف الشخصي" }
  ];
